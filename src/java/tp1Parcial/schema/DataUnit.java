...
public class DataUnit extends org.apache.thrift.TUnion<DataUnit, DataUnit._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.INTERNET_USE_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("internetUseProperty", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, InternetUseProperty.class)));
    tmpMap.put(_Fields.INDIVIDUAL_TYPE_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("individualTypeProperty", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, IndividualTypeProperty.class)));
    tmpMap.put(_Fields.GEOGRAPHY_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("geographyProperty", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, GeographyProperty.class)));
    tmpMap.put(_Fields.FACTS_EDGE, new org.apache.thrift.meta_data.FieldMetaData("factsEdge", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case INTERNET_USE_PROPERTY:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type InternetUseProperty for field 'internetUseProperty', but got " + value.getClass().getSimpleName());
      case INDIVIDUAL_TYPE_PROPERTY:
        if (value instanceof IndividualTypeProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type IndividualTypeProperty for field 'individualTypeProperty', but got " + value.getClass().getSimpleName());
      case GEOGRAPHY_PROPERTY:
        if (value instanceof GeographyProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type GeographyProperty for field 'geographyProperty', but got " + value.getClass().getSimpleName());
      case FACTS_EDGE:
        if (value instanceof FactsEdge) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type FactsEdge for field 'factsEdge', but got " + value.getClass().getSimpleName());
      default:
  ...
  public InternetUseProperty get_internetUseProperty() {
    if (getSetField() == _Fields.INTERNET_USE_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'internetUseProperty' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public IndividualTypeProperty get_individualTypeProperty() {
    if (getSetField() == _Fields.INDIVIDUAL_TYPE_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'individualTypeProperty' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public GeographyProperty get_geographyProperty() {
    if (getSetField() == _Fields.GEOGRAPHY_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'geographyProperty' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public FactsEdge get_factsEdge() {
    if (getSetField() == _Fields.FACTS_EDGE) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'factsEdge' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
